...
#include "webrtc/modules/audio_device/sdl/audio_device_sdl.h"
#endif
...
//
  ...
  if ((audioLayer == kWindowsCoreAudio) ||
	...
	ptrAudioDevice = new AudioDeviceSDL();
    if (!ptrAudioDevice && AudioDeviceWindowsCore::CoreAudioIsSupported()) {
