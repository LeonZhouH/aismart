...
{
	VALIDATE(parent_node_, null_str);
	return calculate_best_size(get_indention_level() - 1, tree_.indention_step_size_);
}
...
void ttree_node::place(const tpoint& origin, const tpoint& size)
{
	...
	ttoggle_panel::set_border_space(left_space);
