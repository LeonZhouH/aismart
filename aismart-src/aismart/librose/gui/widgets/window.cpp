			...
			*this, event::tdispatcher::front_child))
{
	if (!should_conside_orientation(settings::screen_width, settings::screen_height)) {
		// base screen_width, screen_height, adjust orientation_ and original_landscape_.
		orientation_ = landscape_orientation;
		VALIDATE(current_landscape == landscape_orientation, null_str);
	}
