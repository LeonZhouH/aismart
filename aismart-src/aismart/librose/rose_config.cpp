...
void init(const std::string& _app, const std::string& channel, bool landscape)
{
	...
	font::SIZE_SMALLEST = (font::CFG_SIZE_DEFAULT - 6) * gui2::twidget::hdpi_scale;
	font::SIZE_SMALLER = (font::CFG_SIZE_DEFAULT - 4) * gui2::twidget::hdpi_scale;
	font::SIZE_SMALL = (font::CFG_SIZE_DEFAULT - 2) * gui2::twidget::hdpi_scale;
	font::SIZE_DEFAULT = font::CFG_SIZE_DEFAULT * gui2::twidget::hdpi_scale;
	font::SIZE_LARGE = (font::CFG_SIZE_DEFAULT + 2) * gui2::twidget::hdpi_scale;
	font::SIZE_LARGER = (font::CFG_SIZE_DEFAULT + 4) * gui2::twidget::hdpi_scale;
	font::SIZE_LARGEST = (font::CFG_SIZE_DEFAULT + 6) * gui2::twidget::hdpi_scale;

#if (defined(__APPLE__) && TARGET_OS_IPHONE) || defined(ANDROID)
	font::SCROLL_SIZE = 3 * gui2::twidget::hdpi_scale;
#else
	font::SCROLL_SIZE = 8 * gui2::twidget::hdpi_scale;
#endif
