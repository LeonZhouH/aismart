...
#define SDL_SetAppEventHandler SDL_SetAppEventHandler_REAL
#define SDL_SetWindowEventHandler SDL_SetWindowEventHandler_REAL
#define SDL_SetBackgroundHandler SDL_SetBackgroundHandler_REAL
